...
Finalmente, para explorar a fondo las variables la funcion describe es bastante útil, tambien, el comando summary.
...
3. Eliminar las variables rebundantes, se sugiere identificar las variables del conjunto de datos correlacionadas con los últimos componentes
4. Calcular nuevamente los componentes principales expluyendo las variables identificadas en el paso previo
5. Elegir el número de componentes a retener (scree plot, tamaño de los eigen valores, etc)
...
<!--chapter:end:6_clasificacion.Rmd-->
...
<!--chapter:end:7_mineriatexto.Rmd-->
